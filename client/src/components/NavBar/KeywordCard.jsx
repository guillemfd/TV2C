...
function KeywordCard({poster_path, title, release_date, vote_average, id, runtime}) {
    ...
    return (
        <div>
                <div className="card-container" key={id}>
                    <img className="movie-cover" src={IMG_API + poster_path} alt={`Sorry, there is no picture for this`}/>
